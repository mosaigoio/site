...
Each step has a unique shape — its typed inputs, outputs, config, and metadata — and fits with others to form a larger picture. The tiles are connected by their data types, and the mosaic they form is up to you.
